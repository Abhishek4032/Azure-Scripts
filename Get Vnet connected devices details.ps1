        ...
        Write-Host "Collecting info for $vnetname" -ForegroundColor Cyan
    ...
    
            {
                ...
                {   $nicname = $ipconfig.Id.split("/")[8]
                   ...
                   $ipConfig | Select-Object @{n="VNET";e={$VNET.Name}},
    
                   @{n="AddressSpace";e={$VNET | Select-Object -ExpandProperty AddressSpace | Select-Object -ExpandProperty AddressPrefixes}},
    
                   @{n="ConnectedDevice";e={($_.Id).split("/")[8]}},
    
                   @{n="VMname";e={$vmname}},
    
                   @{n="Tag";e={$tag | Select-Object -ExpandProperty Values}},
