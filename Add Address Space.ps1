...
$VNetResourceGroup = "pep-network-sharedservice-eus-01-rg"
$VNetName = "pep-sharedservice-01-eus-vnet"
$Subscription = "pep-sharedservice-01-sub"
$IpAddress = "172.27.24.0/21"
Connect-AzAccount
Write-Host "--------------------------------------------------------------------------------------"
