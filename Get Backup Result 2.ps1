<#
    ...
    Provide either single virtual machine name or in list "VM Names seperated by comma"
    EXP - Testvm, TestVM1
    ...
    $sub | Set-AzContext
    $GetVMs += C:\Users\barax091\Desktop\getstatus.ps1 -AllVirtualMachines
    $GetVMs | Export-Csv C:\Users\barax091\Desktop\result.csv
    }
